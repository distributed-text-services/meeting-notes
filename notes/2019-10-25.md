...
No gold stars for us. They have requested that we provide guidelines for integrating DTS with an IIIF application.  To do this well, we probably need some use cases.
